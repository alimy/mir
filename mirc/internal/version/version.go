...
// BuildVersion is the version of mirc.
const BuildVersion = "5.0.0"

var tag = map[string]int{"pre-alpha": 0, "alpha": 1, "pre-bata": 2, "beta": 3, "released": 4, "": 5}

// GetMircVersion returns BuildVersion
func GetMircVersion() string {
	return BuildVersion
}

// IsVersionGreaterThan compares whether the current mirc version
