...
type _default_ interface {
	...
	BindYaml(*gin.Context, any) error
	Render(*gin.Context, any, error)
	RenderJson(*gin.Context, any, error)
	RenderJsonp(*gin.Context, any, error)
	RenderXML(*gin.Context, any, error)
}
...
func (UnimplementedSiteServant) Logout(c context.Context) error {
	return mir.Errorln(http.StatusNotImplemented, http.StatusText(http.StatusNotImplemented))
}
