...
type Site interface {
	...
	Statics(*gin.Context, *model.LoginReq) error
	Assets(*gin.Context)
	Logout(context.Context) error
	Login(context.Context, *model.LoginReq) (*model.LoginResp, error)
	PrevTweets(context.Context, *model.TweetsReq) (*model.TweetsResp, error)
	NextTweets(context.Context, *model.TweetsReq) (*model.TweetsResp, error)
...
func (UnimplementedSiteServant) Statics(c *gin.Context, req *model.LoginReq) error {
...
func (UnimplementedSiteServant) Login(c context.Context, req *model.LoginReq) (*model.LoginResp, error) {
	return nil, mir.Errorln(http.StatusNotImplemented, http.StatusText(http.StatusNotImplemented))
}

func (UnimplementedSiteServant) PrevTweets(c context.Context, req *model.TweetsReq) (*model.TweetsResp, error) {
	return nil, mir.Errorln(http.StatusNotImplemented, http.StatusText(http.StatusNotImplemented))
}

func (UnimplementedSiteServant) NextTweets(c context.Context, req *model.TweetsReq) (*model.TweetsResp, error) {
	return nil, mir.Errorln(http.StatusNotImplemented, http.StatusText(http.StatusNotImplemented))
}
