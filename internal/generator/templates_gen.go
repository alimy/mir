...
func chi_ifaceTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "chi_iface.tmpl", size: 1521, mode: os.FileMode(0644), modTime: time.Unix(1583599632, 0)}
...
func gin_ifaceTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "gin_iface.tmpl", size: 1040, mode: os.FileMode(0644), modTime: time.Unix(1583599632, 0)}
...
func mux_ifaceTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "mux_iface.tmpl", size: 1557, mode: os.FileMode(0644), modTime: time.Unix(1583599632, 0)}
